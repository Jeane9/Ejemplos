	...
	function woocommerce_catalog_ordering() {
		...
		$catalog_orderby_options = apply_filters(
			...
			array(
				...
				'popularity' => __( 'Recomendados', 'woocommerce' ),
				'rating'     => __( 'Mejor evaluados', 'woocommerce' ),
				'date'       => __( 'Nuevos productos', 'woocommerce' ),
				'price'      => __( 'Precio de menor a mayor', 'woocommerce' ),
				'price-desc' => __( 'Precio de mayor a menor', 'woocommerce' ),
			)
		);
