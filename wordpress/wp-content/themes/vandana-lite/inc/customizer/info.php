...
function vandana_lite_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= '</p><p>';
    $theme_info .= sprintf( __( 'Documentation Link: %1$sClick here.%2$s', 'vandana-lite' ),  '<a href="' . esc_url( 'https://docs.blossomthemes.com/docs/vandana-lite/' ) . '" target="_blank">', '</a>' ); 
    $theme_info .= '</p>';
    ...
    $manager->add_section(
        new Vandana_Lite_Customize_Section_Pro(
            ...
            array(
                ...
                'pro_url'  => esc_url( 'https://blossomthemes.com/downloads/vandana/' ) //@todo Change this url to respective pro theme url.
            )
        )
    );
}
