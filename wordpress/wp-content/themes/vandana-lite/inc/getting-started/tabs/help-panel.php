...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://docs.blossomthemes.com/docs/' . VANDANA_LITE_THEME_TEXTDOMAIN . '/' ); ?>" title="<?php esc_attr_e( 'Visit the Documentation', 'vandana-lite' ); ?>" target="_blank">
    ...
    <div class="panel-aside">
        ...
        <p><?php printf( __( 'It\'s always a good idea to visit our %1$sKnowledge Base%2$s before you send us a support ticket.', 'vandana-lite' ), '<a href="'. esc_url( 'https://docs.blossomthemes.com/docs/' . VANDANA_LITE_THEME_TEXTDOMAIN . '/' ) .'" target="_blank">', '</a>' ); ?></p>
